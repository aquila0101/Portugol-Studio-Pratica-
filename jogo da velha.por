programa
{
	/*Esse programa é um jogo da velha, e ele utiliza conhecimentos de matriz, estruturas de repetição(para e enquanto) e estrutura de condiçaõ(se, senao se, senao)  para funciona;*/
	funcao inicio()
	{
